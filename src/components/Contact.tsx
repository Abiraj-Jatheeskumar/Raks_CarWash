    ...
    <section id="contact" className="section-padding bg-background relative overflow-hidden">
      ...
      >
        <div className="relative">
          <div className="w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-elevated hover:bg-[#20BA5A] hover:scale-110 transition-all duration-300">
