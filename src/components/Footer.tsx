...
const socialLinks = [
  { icon: Facebook, href: "https://www.facebook.com/share/17ZJZ65BuQ/?mibextid=wwXIfr", label: "Facebook", bgColor: "bg-[#1877F2]", hoverBg: "hover:bg-[#1877F2]" },
  { icon: Instagram, href: "https://www.instagram.com/rakscarwash?igsh=MTg2YTVkOGFhaXlpZg==", label: "Instagram", bgColor: "bg-gradient-to-br from-[#f58529] via-[#dd2a7b] to-[#515bd4]", hoverBg: "hover:bg-gradient-to-br hover:from-[#f58529] hover:via-[#dd2a7b] hover:to-[#515bd4]" },
  { icon: TikTokIcon, href: "https://www.tiktok.com/@rakscarwash?_r=1&_t=ZS-91yMHTonqSu", label: "TikTok", bgColor: "bg-[#010101]", hoverBg: "hover:bg-[#000000]" },
  { icon: Youtube, href: "https://youtube.com/@rakscarwash?si=sgHDjzcDattESQ8K", label: "YouTube", bgColor: "bg-[#FF0000]", hoverBg: "hover:bg-[#FF0000]" },
];
